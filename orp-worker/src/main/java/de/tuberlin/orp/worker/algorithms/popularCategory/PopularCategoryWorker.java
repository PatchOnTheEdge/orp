...
public class PopularCategoryWorker extends UntypedActor{
  ...
  public void preStart() throws Exception {
    log.info("Most Popular Category Ranking Worker started.");
    super.preStart();
...
//      log.info(String.format("Received OrpArticle from Publisher: %s with ID: %s, with Categories: %s",
//          context.getPublisherId(), context.getItemId(), Arrays.toString(context.getCategory())));
